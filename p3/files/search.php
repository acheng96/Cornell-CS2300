	...
	<body>
		...
		<div class='search-form-container'>
			<form class='search-form' name='searchForm' action='search.php' onsubmit="return validSearchForm();" method='POST'>
			    <input id='search-album-name-field' type='text' placeholder='ALBUM NAME (DOES NOT INCLUDE ID #)' name='searchAlbumName' title="Letters, numbers, spaces, dashes, commas, and underscores only."><br>
			    <input id='search-photo-name-field' type='text' placeholder='PHOTO NAME (DOES NOT INCLUDE ID #)' name='searchPhotoName' title="Letters, numbers, spaces, dashes, commas, and underscores only."><br>
			    <input id='search-photo-caption-field' type='text' placeholder='PHOTO LOCATION' name='searchPhotoCaption' title="Letters, numbers, spaces, dashes, commas, and underscores only."><br>
